...
namespace PokemonJuego.Controllers
{
    public class PokemonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "pokemon_id,Name,vida,power,Picture")] Pokemon pokemon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "pokemon_id,Name,vida,power,Picture")] Pokemon pokemon)
        {
            if (ModelState.IsValid)
            {
